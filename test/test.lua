...
function test.test_SendCatMessage_party()
	RF.Command( "party" )
	assertEquals( "party", chatLog[2].chatType )
	assertEquals( "Smile!", chatLog[2].msg )
end
function test.test_SendCatMessage_instance()
	RF.Command( "instance" )
	assertEquals( "instance", chatLog[2].chatType )
	assertEquals( "Smile!", chatLog[2].msg )
end
function test.test_SendCatMessage_raid()
	RF.Command( "raid" )
...
-- function test.test_SendCatMessage_whisper()
-- 	RF.Command( "whisper" )
-- 	test.dump(chatLog)
